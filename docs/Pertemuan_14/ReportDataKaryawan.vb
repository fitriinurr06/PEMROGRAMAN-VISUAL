...
Public Class ReportDataKaryawan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UAS_LaporanDataKaryawan.ReportDataKaryawan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportDataKaryawan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDataKaryawan = New ReportDataKaryawan()
        rpt.Site = Me.Site
        Return rpt
    End Function
